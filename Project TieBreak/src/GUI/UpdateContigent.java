 ...
 * @author MikeZJ
 */
public class UpdateContigent extends javax.swing.JFrame
{
...
//            JOptionPane.showMessageDialog(this, "Impossible to create member", "Error 38", JOptionPane.ERROR_MESSAGE);
 ...
 this.dispose();
    ...
    public static void main(String args[])
    {
        ...
        {
            java.util.logging.Logger.getLogger(UpdateContigent.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
